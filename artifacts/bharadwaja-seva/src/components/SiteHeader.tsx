  ...
  return (
    <header className="relative w-full shadow-md bg-primary text-primary-foreground border-b-4 border-accent">
        ...
        >
          <div className="shrink-0">
            <img
              src={LOGO_SRC}
              alt={t("brand.name")}
              className="h-16 sm:h-20 md:h-24 lg:h-36 xl:h-40 w-auto object-contain"
            />
          </div>
      ...
      <div className="hidden lg:block lg:-mt-7 xl:-mt-9 relative z-10">
        <div className="container mx-auto px-4 py-2 flex items-center justify-start gap-6 lg:pl-[11.5rem] xl:pl-[12.5rem]">
